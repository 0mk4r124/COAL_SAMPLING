...
class VEHICLE_LOGS(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["rfid"], name="pr_rfid_idx"),
            models.Index(fields=["create_time"], name="pr_create_time_idx"),
            models.Index(fields=["rfid", "img_1_path", "img_2_path", "img_3_path", "create_time"], name="pr_rfid_img_idx"),
        ]

class VEHICLE_MASTER(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)
    rfid = models.CharField(db_column='RFID', max_length=500, blank=True, null=True)
    vehicle_number = models.CharField(db_column='VEHICLE_NUMBER', max_length=500, blank=True, null=True)
    vendor_code = models.CharField(db_column='VENDOR_CODE', max_length=500, blank=True, null=True)
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["rfid"], name="pr_rfid_idx"),
            models.Index(fields=["vehicle_number"], name="pr_vehicle_number_idx"),
            models.Index(fields=["vendor_code"], name="pr_vendor_code_idx"),
            models.Index(fields=["create_time"], name="pr_create_time_idx"),
            models.Index(fields=["rfid", "vendor_code"], name="pr_rfid_vendor_code_idx"),
            models.Index(fields=["rfid", "vehicle_number"], name="pr_rfid_vehicle_number_idx"),
        ]
...
class VENDOR_MASTER(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["vendor_code"], name="pr_vendor_code_idx"),
            models.Index(fields=["vendor_name"], name="pr_vendor_name_idx"),
            models.Index(fields=["create_time"], name="pr_create_time_idx"),
            models.Index(fields=["vendor_code", "vendor_name"], name="pr_vendor_code_vendor_name_idx"),
        ]
