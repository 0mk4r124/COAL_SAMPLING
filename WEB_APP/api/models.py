...
class PLC_COMM(models.Model):
    ...
    ai_decision    = models.CharField(db_column='AI_DECISION', max_length=20, blank=True, null=True)
    ai_decision_at = models.DateTimeField(db_column='AI_DECISION_AT', blank=True, null=True)
